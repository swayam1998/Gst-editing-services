    ...
    TreeIterationData * data)
{
  ...
  if (duration > e->maxduration) {
    GST_INFO ("%" GES_FORMAT " set duration to %" G_GINT64_FORMAT
        " > max_duration %" G_GINT64_FORMAT, GES_ARGS (e), duration,
        e->maxduration);
    goto error;
  }
  ...
  if (inpoint > e->maxduration) {
    GST_INFO ("%" GES_FORMAT " set inpoint to %" G_GINT64_FORMAT
        " > max_duration %" G_GINT64_FORMAT, GES_ARGS (e), inpoint,
        e->maxduration);
    goto error;
  }
